        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                        ...
                        <input class="form-control" id="id" name="id_barang" value="">
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Kode Barang</label>
                        <input class="form-control" id="kode" name="kode_barang" value="">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Nama Barang</label>
                        <input class="form-control" id="mnama" name="nama_barang" value="">
                    </div>
                    <div class="form-group">
